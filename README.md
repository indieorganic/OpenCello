...
| Lower bout  | ~440 mm                      |
  ...
  - Editing DXF to get the outline for laser cut:
     1. Select and delete intenal enties.
     2. Convert the remaining outline segments into one polyline.
     3. Offset inward by 2.2 mm for inner mold: Tools → Modify → Offset
     4. Export a laser-safe DXF: Save As DXF R2000 (usually safest for CAM)
