...
Step 2: Build the template for inner mold and top/back.
...
| Lower bout  | ~440 mm                      |
  ...
  - Editing DXF to get the outline for laser cut:
     ...
     2. pip install ezdxf (We need python3 >=3.10, too).
     3. Inspect the entities of DXF: using python/dxf_inspect.py.
     ...
     6. Offset inward by 4.7 mm for inner mold: using python/dxf_offset.py. 
     7. Inspect and export a laser-safe DXF: Save As DXF R2000 (usually safest for CAM).
   
| Parameter      | Value                                    |
| -------------- | ---------------------------------------- |
| Rib thickness  | **2.0 mm**                               |
| Plate overhang | **2.7 mm**                               |
| Mold offset    | **4.7 mm inward**                        |
| Mold thickness | **18 mm plywood**                        |
| Mold type      | **inner mold**                            

- An Inner mold template needs: rib-line(inward offset, done), center-line, corner/neck/end block flats, and alignment holes for layers. (to do nextweek...) 
